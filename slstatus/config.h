...
static const struct arg args[] = {
    ...
    { keymap,           "\x04 KMP: %s\x09  :: ",        NULL                  },
    { temp,             "\x05 TMP: %s%%\x09  :: ",      "/sys/class/thermal/thermal_zone0/temp" },
    { uptime,           "\x06 UPT: %s\x09  :: ",        NULL                  },
    { swap_perc,        "\x09 SWP: %s%\x09  :: ",       NULL                  },
    { datetime,         "\x04 DAT: %s\x09  :: ",        "%d:%y"               },
    { disk_perc,        "\x03 DSK: %s%%\x09  :: ",      "/"                   },
    { username,         "\x02 USR: %s\x09",             NULL                  },
    //{ battery_notify, "",       "BAT0"},
};
