...
static const char* pulsar_mime_cmd[] = {"pulsar-mime", NULL};
static const char* pulsar_notes_cmd[] = {"pulsar-notes", NULL};
static const char* pulsar_games_cmd[] = {"pulsar-games", NULL};
...
static const char* pulsar_desktop_cmd[] = {"pulsar-desktop", NULL};
static const char* pulsar_manpages_cmd[] = {"pulsar-manpages", NULL};
static const char* pulsar_execute_cmd[] = {"pulsar-execute", NULL};
static const char* pulsar_process_cmd[] = {"pulsar-process", NULL};
static const char* pulsar_emojis_cmd[] = {"pulsar-emojis", NULL};
static const char* pulsar_projects_cmd[] = {"pulsar-projects", NULL};
static const char* pulsar_pictures_cmd[] = {"pulsar-pictures", NULL};
static const char* pulsar_packages_cmd[] = {"pulsar-packages", NULL};
static const char* pulsar_websearch_cmd[] = {"pulsar-websearch", NULL};
static const char* pulsar_documents_cmd[] = {"pulsar-documents", NULL};
static const char* pulsar_wallpapers_cmd[] = {"pulsar-wallpapers", NULL};
static const char* pulsar_xresources_cmd[] = {"pulsar-xresources", NULL};
static const char* pulsar_keybindings_cmd[] = {"pulsar-keybindings", NULL};
static const char* pulsar_applications_cmd[] = {"pulsar-applications", NULL};
static const char* pulsar_cmdbookmarks_cmd[] = {"pulsar-cmdbookmarks", NULL};
